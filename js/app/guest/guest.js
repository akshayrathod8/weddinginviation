...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'The Wedding of Akshay and Dipika',
            dates: `${formatDate('2026-05-03 18:55')}/${formatDate('2026-05-03 18:55')}`,
            details: 'Without diminishing respect, we invite you to attend our wedding event.',
            location: 'Madhura Lawns, Harsul, Chhatrapati Sambhajinagar, Maharashtra 431008',
            ctz: config.get('tz'),
        });
    ...
    const booting = async () => {
        ...
        if (information.has('presence')) {
            ...
            if (presenceEl) presenceEl.value = information.get('presence') ? '1' : '2';
        }
